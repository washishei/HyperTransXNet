...
class MaSAd(nn.Module):
    ...
    def forward(self, x: torch.Tensor, rel_pos, chunkwise_recurrent=False, incremental_state=None):
        ...
        print(mask_w.shape, mask_h.shape)
        ...
        # print(qk_mat_w.shape, mask_w.shape)
...
@register_model
def HRMT_T(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = HVisRetNet(
...
@register_model
def HRMT_S(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = HVisRetNet(
        embed_dims=[64, 128, 256, 512],
        depths=[3, 4, 18, 4],
        num_heads=[4, 4, 8, 16],
...
@register_model
def HRMT_B(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = HVisRetNet(
...
@register_model
def HRMT_L(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = HVisRetNet(
