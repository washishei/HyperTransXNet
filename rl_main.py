...
from rl_models import get_model, train, test, save_model, t_SNE, applyPCA
# from rl_models import AdvancedRLTrainer as train
...
parser.add_argument(
    "--dataset", type=str, default="whulk", choices=dataset_names,
...
for run in range(N_RUNS):
    ...
    if MODEL == "SVM_grid":
        ...
        if t_sne:
            ...
            model.load_state_dict(torch.load(
                "E:/UM/BF/DeepHyperX-Transformer/checkpoints/vi_t/IndianPines/2024_03_28_14_59_33_epoch100_1.00.pth"))  ##
            train_dataset = HyperX(img, train_gt, **hyperparams)
            # train_loader = data.DataLoader(
            #     train_dataset,
            #     batch_size=hyperparams["batch_size"],
