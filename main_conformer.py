...
from models_conformer import get_model, train, test, save_model, t_SNE
...
for run in range(N_RUNS):
    ...
    if MODEL == "SVM_grid":
        ...
        train_gt, val_gt = sample_gt(train_gt, 0.85, mode="random")
        ...
        if t_sne:
            ...
            model.load_state_dict(torch.load("E:/UM/BF/DeepHyperX-Transformer/checkpoints/conformer/IndianPines/2024_03_08_10_08_27_epoch100_1.00.pth"))
