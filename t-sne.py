...
#print(im_mat1.keys())
im_mat1 = loadmat('E:/UM/BF/DeepHyperX-Transformer/Datasets/IndianPines/Indian_pines_corrected.mat') #Change to own directory
...
im_mat2 = loadmat('E:/UM/BF/DeepHyperX-Transformer/Datasets/IndianPines/Indian_pines_gt.mat')
