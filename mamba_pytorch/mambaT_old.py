...
class MambaLayer(nn.Module):
    def __init__(self, in_chans, dim, d_state=16, d_conv=4, expand=2):
        ...
        self.transformer = Transformer(dim=in_chans, proj_kernel=3, kv_proj_stride=1, depth=1, heads=2, mlp_mult=2, dropout=0)
...
def main():
    input_value = np.random.randn(2, 1, 3, 16, 16)
