...
class Conformer(nn.Module):
    ...
    def __init__(self, patch_size=16, in_chans=3, num_classes=1000, base_channel=64, channel_ratio=4, num_med_block=0,
                 embed_dim=768, depth=6, num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None,
        ...
        self.conv_cls_head = nn.Linear(int(256), num_classes)
...
if __name__ == '__main__':
    img_size = 15
    x = torch.rand(4, 1, 256, img_size, img_size)
    model = Conformer(num_classes=16, in_chans=256,)
