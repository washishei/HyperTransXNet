...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        self.H, self.W = img_size[0] // patch_size[0], img_size[1] // patch_size[
            1]  # Note: self.H, self.W and self.num_patches are not used
...
class CoaT(nn.Module):
    ...
    def __init__(self, img_size=15, patch_size=3, in_chans=3, num_classes=1000, embed_dims=[0, 0, 0, 0],
