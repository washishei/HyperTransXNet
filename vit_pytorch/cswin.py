...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2, 2, 6, 2],
                 split_size=[3, 5, 7],
...
model = CSWinTransformer(patch_size=4, embed_dim=144, depth=[2, 4, 32, 2],
                             split_size=[1, 2, 7, 7], num_heads=[6, 12, 24, 24], mlp_ratio=4., in_chans=4, num_classes=10)
out = model(x)
print(out)