...
class SSFTTnet(nn.Module):
    def __init__(self, in_channels=1, num_classes=NUM_CLASS, num_tokens=1, dim=64, depth=1, heads=2, mlp_dim=2, dropout=0.1, emb_dropout=0.1):
